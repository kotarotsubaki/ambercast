...
export const CLI_MANIFEST: VersionlessCliManifest = {
  commands: [
    ...
    {
      name: 'mcp',
      summary: 'Serve the MCP stdio server',
      positional: null,
      flags: [
        { name: 'dir', alias: null, value: '<path>', hidden: false, acceptedValues: null, shownValue: null, effect: 'session root to serve', default: 'cwd', lineBreakAfter: false },
        { name: 'sync-wait-ms', alias: null, value: '<n>', hidden: false, acceptedValues: null, shownValue: null, effect: 'synchronous response wait bound in milliseconds', default: '45000', lineBreakAfter: false },
      ],
    },
  ],
