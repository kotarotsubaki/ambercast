...
const reportDocuments = [
  ...
  [
    'a generate listed row with forbidden AI accounting evidence',
    {
      ...reportEnvelopeFields,
      command: 'generate',
      results: [{
  ...
  [
    'a run listed row with forbidden AI accounting evidence',
    {
      ...reportEnvelopeFields,
      command: 'run',
      results: [{
  ...
  [
    'a check row with forbidden AI accounting evidence',
    {
      ...reportEnvelopeFields,
      command: 'check',
      results: [{
        ...
        planFile: 'cases/check.ambercast.plan.json',
        status: 'fresh',
        reason: 'The plan inputs are current.',
        aiCalls: 0,
      }],
    },
    false,
  ...
  [
    'a generate row with a fractional AI call count',
    {
      ...reportEnvelopeFields,
      command: 'generate',
      results: [{
  ...
  [
    'a heal row with a negative AI call count',
    {
      ...reportEnvelopeFields,
      command: 'heal',
      results: [{
