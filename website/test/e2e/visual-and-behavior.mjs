  ...
  try {
    ...
    const computed = await page.evaluate(() => {
      ...
      return {
        ...
        ledger: value('.landing-ledger'), ledgerRow: value('.landing-ledger-row'), ledgerLastRow: value('.landing-ledger-row:last-child'), ledgerNumber: value('.landing-ledger-row > span'), ledgerCommand: value('.landing-ledger-row code'), ledgerDescription: value('.landing-ledger-row p'), ledgerPill: value('.landing-ledger-row b'), prereq: value('.landing-prerequisites dl'), prereqCell: value('.landing-prerequisites dd'), prereqLabel: value('.landing-prerequisites dt'), prereqValue: value('.landing-prereq-value'), prereqNote: value('.landing-prereq-note'), section: value('.landing-section'), sectionWash: value('.landing-section', '::before'), prompt: value('.demo-prompt-body'), promptHeading: value('.demo-prompt-heading'),
    ...
    for (const [label, item, base] of [
      ...
      ['prompt body', computed.prompt, 'rgb(46, 38, 32)'], ['prompt heading', computed.promptHeading, 'rgb(46, 38, 32)'], ['JSON key', computed.key, 'rgb(46, 38, 32)'], ['JSON value', computed.jsonValue, 'rgb(46, 38, 32)'],
